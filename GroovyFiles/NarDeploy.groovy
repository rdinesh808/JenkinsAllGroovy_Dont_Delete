...
def call(body) {
    ...
    node {
        ...
        stage('Downloading Nar files'){
        try{               
                                     
        def PS_NexusDownload = "D:/jenkins_utils/deployment_v2/ps/downaloadnexus.ps1"
        bat script: "${getPSCmd(PS_NexusDownload)}"
                              
        }catch(e){
            print e
        }
        }
        stage('Downloading Nar from Nexus'){
        try{
		if(("${environment}"=="Dev")){
        	...
        	String remoteGetCommandDev = "echo y | D:\\PuTTY\\pscp.exe -pw P@ssw0rd1 -r D:\\Jenkins\\nifi-workflows\\nexus-download\\* cdnonprod@Devzk01:/usr/hdf/${nifiVersion}/nifi/lib"
        	...
        	String remoteGetCommand01Dev = "echo y | D:\\PuTTY\\pscp.exe -pw P@ssw0rd1 -r D:\\Jenkins\\nifi-workflows\\nexus-download\\* cdnonprod@Devzk02:/usr/hdf/${nifiVersion}/nifi/lib"
        	...
        	String remoteGetCommand02Dev = "echo y | D:\\PuTTY\\pscp.exe -pw P@ssw0rd1 -r D:\\Jenkins\\nifi-workflows\\nexus-download\\* cdnonprod@Devzk03:/usr/hdf/${nifiVersion}/nifi/lib"
        	...
        	String remoteGetCommandQa = "echo y | D:\\PuTTY\\pscp.exe -pw P@ssw0rd1 -r D:\\Jenkins\\nifi-workflows\\nexus-download\\* cdnonprod@10.168.54.67:/usr/hdf/${nifiVersion}/nifi/lib"
        	...
        	String remoteGetCommand01Qa = "echo y | D:\\PuTTY\\pscp.exe -pw P@ssw0rd1 -r D:\\Jenkins\\nifi-workflows\\nexus-download\\* cdnonprod@10.168.54.68:/usr/hdf/${nifiVersion}/nifi/lib"
        	...
        	String remoteGetCommand02Qa = "echo y | D:\\PuTTY\\pscp.exe -pw P@ssw0rd1 -r D:\\Jenkins\\nifi-workflows\\nexus-download\\* cdnonprod@10.168.54.69:/usr/hdf/${nifiVersion}/nifi/lib"
