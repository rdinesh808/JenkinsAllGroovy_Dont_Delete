...
PS_COPY  =  "D:/ps/htmltosharesurl.ps1" + " -jobPath '${currentjobPath}' -jobName '${env.JOB_NAME}'"
...
def reportFile="xcopy /s /Q /F /Y \"${projectWorkspace}/CustomizedReports/*.html\" \"${reportpath}/UrlExposed/\""
bat "${reportFile}"
...
DEFAULT_CONTENT="UrlExposed Script execution failed for ${env.JOB_NAME}"
}    
if (status){    
