...
PS_COPY  = "D:/ps/htmltosharesreg.ps1" + " -jobPath '${currentjobPath}' -jobName '${env.JOB_NAME}'"
...
bat script: "${getPSCmd(PS_COPY)}"
try{
ScreenShot_COPY  = "D:/ps/screenshotcpfullregression.ps1" + " -jobPath '${currentjobPath}' -jobName '${env.JOB_NAME}'"
...
def reportFile="xcopy /s /Q /F /Y \"${projectWorkspace}/CustomizedReports/*.html\" \"${reportpath}/DailyNonProd/\""
bat "${reportFile}"
// if(!status){
// try{
// ScreenShot_COPY  = "D:/ps/screenshotcppostdeploy.ps1" + " -jobPath '${currentjobPath}' -jobName '${env.JOB_NAME}'"
// bat script: "${getPSCmd(ScreenShot_COPY)}"
// }catch (e){
// echo "e"
// }
