    ...
    node {
		...
		stage('Checkout from BitBucket'){
				...
				dir("./${config.KatalonRep}") {
					def checkoutResult = git credentialsId: 'cf7a0040-05b2-4835-b49e-8e5814141f5b', url: "https://sadhasivim@bitbucket.org/gsihealth/automationjunitreports.git", changeLog:true
