...
def call(body) {
  ...
  dir("./Dashboard_Liquibase") {
            //Checkout the latest code
		def checkoutResult = git credentialsId: '60c19ca5-84bb-4508-a665-0c7895d3031b', url: "https://sadhasivim@bitbucket.org/gsihealth/dashboard_liquibase.git", changeLog:true
              task.checkoutResult = checkoutResult
			   }
        }
            stage('Build'){
