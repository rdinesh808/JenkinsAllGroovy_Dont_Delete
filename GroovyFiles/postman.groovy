...
//2nd Stage
stage('NewMan Test Execution'){
try{
dir("${config.postmanRep}/test"){
bat "newman run ${config.collectionName}.json -g token.json --reporters cli,junit --reporter-junit-export newman.xml"
